...
public class ConfigManager {
	  ...
	  * @since EQUIOS V2.00EQ001T1 EQF#C320-003
	  */
	public static boolean loadXXXXConfig() {
		try {
			...
			try {
				...
				JOptionPaneUtils
						.showErrorDialog(
								null,
								SmartHFResource
										.getResource(LangKey.MSG_ERR_LOADFOLDERSTRUCTURENFLCFAIL));
	...
	public static boolean checkSingleInstance(){
        ...
        if (!lockInstance) {
            JOptionPaneUtils.showErrorDialog(null, SmartHFResource.getResource(LangKey.MSG_ERR_SINGLEINSTANCE));
            return false;
        }
        return true;
    }
