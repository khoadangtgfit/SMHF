...
public class Constants {
  ...
  public static final String LOG4J_CONFIG_FILE = APPLICATION_DIR + "tool/lib/SkeletionXXXXTool/" + "log4j.properties";

  /** The Constant INI_CONFIG_FILE. */
  public static final String INI_CONFIG_FILE = APPLICATION_DIR + "tool/lib/SkeletionXXXXTool/" + "XXXX.ini";
  ...
  public static int MAX_NEW_ROWS = 3;
